...
python -m np_utils.si_utils.submit_si_jobs from np_utils folder
"""
...
def main():
    ...
    run_queue = ["NP154_B3"]#np.intersect1d(have_nwb, need_si).tolist()
    ...
    submit_rec_queue(
        ...
        check_interval=30,
        gpus=1,
        extra_args_per_rec=lambda rec_id: ["--sparse"],
    )
